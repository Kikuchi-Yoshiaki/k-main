        ...
        <div id="app">
            ...
            <div class="container-fluid category">
                <div class="row category-menu">
                    <div class="category-list col-sm-6 col-md-3">
                        <a class="nav-link category-name" href="{{ url('article/index') }}">気仙沼の<span> 遊ぶ</span></a>
                    </div>
                    <div class="category-list col-sm-6 col-md-3">
                        <a class="nav-link category-name" href="{{ url('article/index') }}">気仙沼の<span> 食べる<span></span></a>
                    </div>
                    <div class="category-list col-sm-6 col-md-3">
                        <a class="nav-link category-name" href="{{ url('article/index') }}">気仙沼の<span> 生活</span></a>
                    </div>
                    <div class="category-list col-sm-6 col-md-3">
