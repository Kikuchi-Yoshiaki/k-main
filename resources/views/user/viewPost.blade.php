...
@section('content')
    ...
    <div class="container form-container">
        <div class="wrapper">
            <form action="{{ action('ViewController@create') }}" method="POST" name="view-post" class="form-box" enctype="multipart/form-data">
                <h3 class="form-title mb-4 mt-3">風景・画像を投稿する</h3>
                
                <!-- 画像選択 -->
                <div class="mb-4">
                    <label class="form-label mb-2 mr-1">画像選択</label>
                    <span class="text-danger small">※任意(jpg, png, jpeg形式,最大10MB)</span>
